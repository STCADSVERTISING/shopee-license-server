...
app.get('/', (req, res) => {
  res.send('<h1>📡 ShopFlow License Server Online</h1><p>ระบบเซิร์ฟเวอร์เช็คสิทธิ์ใบอนุญาตและบริการจัดการคีย์อัจฉริยะออนไลน์เปิดพร้อมใช้งานแล้ว</p>');
});

// ให้บริการแดชบอร์ดจัดการคีย์แอดมินโดยตรงจากเซิร์ฟเวอร์คลาวด์เพื่อขจัดปัญหา CORS บล็อก 100%
